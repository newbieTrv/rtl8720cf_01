...
/**
 * @Function: pre_tuya_iot_init
 * @Description: 设备初始化之后，照明类产品快速点亮函数
 * @Input: none
 * @Output: none
 * @Return: none
 * @Others: none
...
VOID tuya_device_config(VOID)
{
    ...
    dev_param.wifi_led.io_pin = TY_GPIOA_18;
    dev_param.wifi_led.io_level = IO_LOW_LEVEL;
    dev_param.key_control.io_config.io_pin = TY_GPIOA_4;
    ...
    dev_param.relay.io_pin = TY_GPIOA_3;
    ...
    dev_param.relay_led.io_pin = TY_GPIOA_19;
